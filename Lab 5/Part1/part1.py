...
""".format(bucket))
    ...
    "name": "allow-5000-api-1",
    "network": "https://www.googleapis.com/compute/v1/projects/lab5-328218/global/networks/default",
    "priority": 1000,
    "selfLink": "https://www.googleapis.com/compute/v1/projects/lab5-328218/global/firewalls/allow-5000",
    "sourceRanges": [
      "0.0.0.0/0"
    ],
    "targetTags": [
    ...
    print("Instance Fingerprint: {}".format(my_fingerprint))
