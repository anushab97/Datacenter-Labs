...
project = os.getenv('GOOGLE_CLOUD_PROJECT') or 'avian-compiler-324721'
...
#
# [START run]
def main(project, bucket, zone, instance_name, wait=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--bucket_name', default='datacenterbucket1' ,help='Your Google Cloud Storage bucket name.')
    parser.add_argument(
        '--zone',
